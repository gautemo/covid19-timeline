...
const countries = new Map([
    ...
    ['AE', { latitude: 23.424076, longitude: 53.847818, name: `UAE` }],
    ...
    ['BA',	{latitude: 43.915886, longitude: 17.679076, name: `Bosnia` }],
    ...
    ['CD',	{latitude: -4.038333, longitude: 21.758664, name: `DRC` }],
    ['CF',	{latitude: 6.611111, longitude: 20.939444, name: `Central African Republic` }],
    ['CG',	{latitude: -0.228021, longitude: 15.827659, name: `Congo` }],
    ...
    ['GB', { latitude: 55.378051, longitude: -3.435973, name: `UK` }],
    ...
    ['GZ', { latitude: 31.354676, longitude: 34.308825, name: `West Bank and Gaza` }],
    ...
    ['KR',	{latitude: 35.907757, longitude: 127.766922, name: `S. Korea` }],
    ...
    ['LA', { latitude: 19.85627, longitude: 102.495496, name: `Lao People's Democratic Republic` }],
    ...
    ['LY', { latitude: 26.3351, longitude: 17.228331, name: `Libyan Arab Jamahiriya` }],
    ...
    ['MK',	{latitude: 41.608635, longitude: 21.745275, name: `Macedonia` }],
    ['ML',	{latitude: 17.570692, longitude: -3.996166, name: `Mali` }],
    ['MM',	{latitude: 21.913965, longitude: 95.956223, name: `Burma` }],
    ...
    ['ST', { latitude: 0.18636, longitude: 6.613081, name: `Sao Tome and Principe` }],
    ['SV',	{latitude: 13.794185, longitude: -88.89653, name: `El Salvador` }],
    ['SY', { latitude: 34.802075, longitude: 38.996815, name: `Syrian Arab Republic` }],
    ...
    ['UM',	{latitude: 19.3, longitude: 166.633333, name: `U.S. Minor Outlying Islands` }],
    ['US',	{latitude: 37.09024, longitude: -95.712891, name: `USA` }],
    ['UY',	{latitude: -32.522779, longitude: -55.765835, name: `Uruguay` }],
    ['UZ',	{latitude: 41.377491, longitude: 64.585262, name: `Uzbekistan` }],
    ['VA', { latitude: 41.902916, longitude: 12.453389, name: `Holy See` }],
    ...
    ['VI',	{latitude: 18.335765, longitude: -64.896335, name: `U.S. Virgin Islands` }],
...
const getCountry = (name) => ([...countries].find(([_, c]) => c.name === name) || [])[1];
